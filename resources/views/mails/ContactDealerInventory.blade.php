...
@section('content')
    ...
    <h4 class="secondary"><strong style="text-transform: uppercase">{{ $data['country_name'] }} Inventory REQUEST
            FORM</strong>
    </h4>
    ...
    <p><b>What is your request : </b>{{ $data['message']['reason_for_contact'] }}</p>
