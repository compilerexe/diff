...
<body class="bg-dark">
@include('layouts.new_design.dealer.navbar')
...
<script>
    ...
    @if (session('update_status') || session('update_status') == 'success')
    swal('Update Success', '', 'success');
    @endif

    @if (session('update_status') == 'wait_approve')
    swal('Please wait for admin to approve.', '', 'success');
    @endif
</script>
@stack('scripts')
</body>
